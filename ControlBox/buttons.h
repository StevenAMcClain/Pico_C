...
#define R_ENCBUT  GPIO_PIN_0
#define L_ENCBUT  GPIO_PIN_1
#define L_BUTTON  GPIO_PIN_2
#define SWITCH    GPIO_PIN_3
#define R_BUTTON  GPIO_PIN_4

#define ALL_BUTTONS  ((L_ENCBUT | R_ENCBUT) | (L_BUTTON | R_BUTTON) | SWITCH)
