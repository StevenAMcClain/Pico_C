...
PRIVATE BENG_VAR BEng_Internal_Vars[MAX_BENG_INTERNAL] = 
{
    ...
    {BENG_VAR_TYPE_UINT   | BENG_VAR_TYPE_POINTER, BENG_VAR_IDX_SCOPE_INTERNAL +  1, "BRIGHT", .value.ptr = &LED_Brightness,           NIL, NIL},
    ...
    {BENG_VAR_TYPE_UINT   | BENG_VAR_TYPE_POINTER, BENG_VAR_IDX_SCOPE_INTERNAL + 11,   "TIK0", .value.ptr = &Beng_State[0].Tick_Speed, NIL, NIL},
    {BENG_VAR_TYPE_UINT   | BENG_VAR_TYPE_POINTER, BENG_VAR_IDX_SCOPE_INTERNAL + 12,   "TIK1", .value.ptr = &Beng_State[1].Tick_Speed, NIL, NIL},
    {BENG_VAR_TYPE_UINT   | BENG_VAR_TYPE_POINTER, BENG_VAR_IDX_SCOPE_INTERNAL + 13,   "TIK2", .value.ptr = &Beng_State[2].Tick_Speed, NIL, NIL},
    {BENG_VAR_TYPE_UINT   | BENG_VAR_TYPE_POINTER, BENG_VAR_IDX_SCOPE_INTERNAL + 14,   "TIK3", .value.ptr = &Beng_State[3].Tick_Speed, NIL, NIL},
    {BENG_VAR_TYPE_UINT   | BENG_VAR_TYPE_POINTER, BENG_VAR_IDX_SCOPE_INTERNAL + 15,   "TIK4", .value.ptr = &Beng_State[4].Tick_Speed, NIL, NIL},
    {BENG_VAR_TYPE_UINT   | BENG_VAR_TYPE_POINTER, BENG_VAR_IDX_SCOPE_INTERNAL + 16,   "TIK5", .value.ptr = &Beng_State[5].Tick_Speed, NIL, NIL},
    {BENG_VAR_TYPE_UINT   | BENG_VAR_TYPE_POINTER, BENG_VAR_IDX_SCOPE_INTERNAL + 17,   "TIK6", .value.ptr = &Beng_State[6].Tick_Speed, NIL, NIL},
    {BENG_VAR_TYPE_UINT   | BENG_VAR_TYPE_POINTER, BENG_VAR_IDX_SCOPE_INTERNAL + 18,   "TIK7", .value.ptr = &Beng_State[7].Tick_Speed, NIL, NIL},
};
